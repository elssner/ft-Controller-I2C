...
* (40) Quellcodedateien im GitLab Projekt [ft_Controller_I2C](https://git.fischertechnik-cloud.com/i2c/ft_Controller_I2C) 
  * (1) i2cCode
  * (26) mit <code>I²C-Adresse</code>: sind einem bestimmten I²C Modul zugeordnet.
...
[serial](#serialpy)|<code>0x4D</code>|[UART SC16IS752](https://www.amazon.de/dp/B0DBZRPSZ4) und [Cytron MQTT 8266](https://www.cytron.io/p-grove-wifi-8266-iot-for-microbit-and-beyond)
...
Block **decode_latin** (data_bytes) : String aus Liste (Unicode-Codepoints) *''.join(chr(b) for b in data_bytes)*\
...
> Der Sensor erkennt mit einer kleinen Kamera auf der Leiterplatte 5 Gesten, die ein Mensch mit der Hand macht. Wenn der Mensch an Kopf und Schulter erkannt wird, leuchtet die weiße LED.
