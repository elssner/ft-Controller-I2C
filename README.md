...
Somit kann beim **TXT 4.0 Controller** ![](ereignis_fototransistor.png) ausgelöst werden. Im Ereignis-Code → [button_event](examples#qwiicbutton_intpy) wird über den I²C-Bus das auslösende Modul gesucht und dessen /INT zurück gesetzt. → [buttons_interrupt](examples#qwiicbutton_intpy)\
